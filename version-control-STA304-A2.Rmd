...
The 95% bound on the error (used 2 instead of 1.96 as an approximation) is: $B_1=2*\sqrt{\hat Var(\hat x)}=7.5585$\
The 95% confidence interval (used 2 instead of 1.96 as an approximation) is: (62.3790, 77.4961).
